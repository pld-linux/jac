...
%description -l pl
Jac jest dzia³aj±cym z linii poleceñ odtwarzaczem CD, który pozwala Ci 
...
konsolê, dla tych co wol± konsolê od procesu w tle. Jac potrafi regulowaæ
g³o¶no¶æ (u¿ywaj±c urz±dzenia(sic!) mixer, je¶li jest) oraz podaje Ci 
dok³adne informacje o Twoim CD. Jac potrafi pobraæ informacje o p³ycie 
z baz CDDB(www.cddb.com) i z CdIndex(www.cdindex.org) oraz czytaæ CDDB 
